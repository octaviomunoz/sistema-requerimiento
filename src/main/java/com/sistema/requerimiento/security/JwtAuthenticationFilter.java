...
import static com.sistema.requerimiento.utils.Constantes.HEADER_AUTHORIZATION_KEY;
import static com.sistema.requerimiento.utils.Constantes.TOKEN_BEARER_PREFIX;
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			return authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(
					userCredentials.getRut(), userCredentials.getPassword()));
		} catch (IOException e) {
